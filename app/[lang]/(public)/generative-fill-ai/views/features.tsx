      ...
      <div className="max-w-7xl space-y-10 md:space-y-0 md:space-x-6 md:flex md:justify-between">
        <div className="flex-grow">
          <div className="flex flex-col items-center text-center">
            ...
            <h2 className="mt-4 font-semibold text-gray-900">{t`Free Generative Fill AI`}</h2>
            <p className="mt-2 text-sm text-gray-500 max-w-[500px]">
              {t`Start for free with the generative fill ai. Expand your first 3 images at no charge.`}
            </p>
          </div>
        </div>
